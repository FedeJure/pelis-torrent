...
const searchMovies = async query => (await fetch(`https://api.themoviedb.org/3/search/movie?api_key=133f4d8b4fed128b27fa0bb407956c56&language=en-US&page=1&include_adult=false&query=${query}`)).json();
